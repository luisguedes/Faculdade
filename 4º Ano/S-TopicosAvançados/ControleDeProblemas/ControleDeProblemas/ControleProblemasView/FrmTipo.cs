...
namespace ControleProblemasView
{
    public partial class FrmTipo : Form
    {
        ...
        {
            Tipo tipo = new Tipo();
            //tipo.Id = Convert.ToInt32(txtId.Text); Comentei pois no banco está auto incremente (identity)
            tipo.Descricao = txtDescricao.Text;

            MessageBox.Show("Olá turma!" + tipo);
            //new TipoDB().insert(tipo); usei para teste
        ...
        private void lblsdfs_Click(object sender, EventArgs e)
        {
