<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="EstacionamentoSaida.aspx.cs" Inherits="ProjEstacionamento.EstacionamentoSaida" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <form id="form1" runat="server">
        <article class="kanban-entry grab" id="item1" draggable="true">
            <div class="kanban-entry-inner">
                <div class="kanban-label">
                    <h2><a href="#">Estacionamento Saida</a> <span></span></h2>
                    <p></p>
                </div>
            </div>
        </article>
        ...
        <div class="form-group">
            <label for="Data">DataSaida:</label>
            <asp:TextBox class="form-control" name="txtDatasaida" ID="txtDatasaida"
                runat="server"></asp:TextBox>
        </div>
        <div class="form-group">
