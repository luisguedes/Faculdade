...
namespace ProjEstacionamento
{
    public partial class EstacionamentoSaida : System.Web.UI.Page
    {
        ...
        protected void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            string dtsai = txtDatasaida.Text;
            string nomecli = txtNomecliente.Text;
            string telef = txtTelefone.Text;
            string val = txtValor.Text;
            TB_ESTACIONAMENTO v = new TB_ESTACIONAMENTO() { descricao = descr, dataentrada = dtsai, nomecliente = nomecli, telefone = telef, valor = val };
        ...
        private void CarregarDadosPagina()
        {
            ...
            if (!String.IsNullOrEmpty(valor))
            {
                ...
                txtDatasaida.Text = estac.datasaida;
