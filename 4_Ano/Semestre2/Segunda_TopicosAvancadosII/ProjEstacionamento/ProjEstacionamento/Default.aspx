<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ProjEstacionamento.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <form runat="server">
        <asp:GridView ID="GVESTAENTRADA" runat="server" CellPadding="4" CssClass="table" ForeColor="#333333"
            GridLines="None" AutoGenerateColumns="False" OnRowCommand="GVESTAENTRADA_RowCommand">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Dataentrada" HeaderText="DATAENTRADA" />
